        ...
        <div class="container">
            ...
            <ul class="navbar-nav navbar-vertical ms-xl-4 d-none d-xl-flex">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-md bg-dark rounded py-4 mt-4" aria-labelledby="navbarVerticalMenu">
                        <?php 
                            $cat_sql="select * from categories_tbl";
                            //echo $sql;die;
                            $cat_row=mysqli_query($cnn,$cat_sql);
                             while($cat_result=mysqli_fetch_array($cat_row))
                            {  
                        ?>
                        <li class="dropdown-item dropright">
                            <a class="dropdown-link dropdown-toggle" data-bs-toggle="dropdown" href="#">
                                ...
                                <?php echo $cat_result['categories_name']; ?>
                            </a>
                            ...
                            <div class="dropdown-menu ps-3 top-0 pe-0 py-0 shadow-none bg-transparent">
                                <div class="dropdown-menu-md bg-dark rounded dropdown-menu-inner">
                                   <?php 
                                        $sub_sql="select * from sub_categories_tbl,categories_tbl where categories_tbl.categories_id=sub_categories_tbl.categories_id and sub_categories_tbl.categories_id='".$cat_result['categories_id']."' and sub_cat_status='1' ";
                                        // echo $sub_sql;
            ...
            <ul class="navbar-nav flex-row ms-n4 ms-sm-auto ms-xl-0 me-n2 me-md-n4">
                ...
                <li class="nav-item border-0 px-1 px-md-3">
                    ...
                    <a href="#" class="nav-link d-flex p-3 bg-white-all rounded-circle position-relative text-gigas icon-xs" data-bs-toggle="modal" data-bs-target="#cartModal">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link d-flex p-3 bg-white-all rounded-circle text-gigas icon-xs">
                        <!-- Icon -->
                        <!-- <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
