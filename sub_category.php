    ...
    <section class="pt-5 pb-9 py-md-11 bg-white">
        <div class="container">
            <div class="text-center mb-5 mb-md-8">
                 <?php 
            $str_course="select * from sub_categories_tbl,course_tbl,topic_tbl where topic_tbl.sub_cat_id=sub_categories_tbl.sub_cat_id and course_tbl.topic_id=topic_tbl.topic_id and topic_tbl.sub_cat_id='".$_GET['sub_cat_id']."'";
            //echo $str_course;
            $data_course=mysqli_query($cnn,$str_course);
            $cnt=mysqli_num_rows($data_course);
            if($cnt>0) {
            $row_course=mysqli_fetch_array($data_course);
            ?>
                <h1 class="mb-1"><?php echo $row_course['sub_cat_name']; ?></h1>
            ...
            <?php } ?>    
            <div class="text-center">
                <a href="./course_list.php" class="btn btn-gigas btn-x-wide rounded-lg lift mt-4">VIEW ALL COURSES</a>
            </div>
        </div>
    </section>
