...
foreach($brandis as $idss)
{ 
$idss;
}
$brandii=implode("','",$idss); //change into comma separated value to sub array
//echo "<br>";
$sql = mysqli_query($cnn,"select * from course_tbl,tutor_tbl 
						WHERE course_tbl.tutor_id=tutor_tbl.tutor_id and  
						tutor_tbl.tutor_id IN ('$brandii')");
?>
