    ...
    <section class="pt-5 pb-9 py-md-11 bg-white">
        <div class="container">
            <div class="text-center mb-5 mb-md-8">
                ...
                <?php 
                $str_course="select * from categories_tbl,sub_categories_tbl,course_tbl,topic_tbl where topic_tbl.sub_cat_id=sub_categories_tbl.sub_cat_id and sub_categories_tbl.categories_id=categories_tbl.categories_id and course_tbl.topic_id=topic_tbl.topic_id and sub_categories_tbl.categories_id='".$_GET['categories_id']."'";
                // echo $str_course;
                $data_course=mysqli_query($cnn,$str_course);
                $row_course=mysqli_fetch_array($data_course)
                ?>
                <h1 class="mb-1"><?php echo $row_course['categories_name']; ?></h1>
            ...
            <div class="row mb-3">
                <?php 
            $str_course="select * from categories_tbl,sub_categories_tbl,course_tbl,topic_tbl where topic_tbl.sub_cat_id=sub_categories_tbl.sub_cat_id and sub_categories_tbl.categories_id=categories_tbl.categories_id and course_tbl.topic_id=topic_tbl.topic_id and course_tbl.course_id='".$_GET['course_id']."'";
            echo $str_course;
            $data_course=mysqli_query($cnn,$str_course);
            // $_SESSION['cat_name']=$row_course['categories_name'];
