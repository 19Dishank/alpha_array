        ...
        <div class="row row-cols-md-2 row-cols-lg-3 mb-4">
            <div class="col-md mb-6">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="./event_schedule.php" class="card-img d-block sk-thumbnail img-ratio-3 card-hover-overlay"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-1.jpg" alt="..."></a>
                        <a href="./event_schedule.php" class="text-underline text-white card-text-overlay position-absolute h5 mb-0 center">GET TICKET</a>
                        <a href="./event_schedule.php" class="badge sk-fade-bottom badge-lg badge-orange badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                    ...
                    <div class="card-footer px-2 pb-2 pt-4">
                        <!-- Heading -->
                        <a href="./event_schedule.php" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52 mb-2">Discover Law - Get into the best UK law schools</h5></a>
            ...
            <div class="col-md mb-6">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="./event_schedule.php" class="card-img d-block sk-thumbnail img-ratio-3 card-hover-overlay"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-2.jpg" alt="..."></a>
                        <a href="./event_schedule.php" class="text-underline text-white card-text-overlay position-absolute h5 mb-0 center">GET TICKET</a>
                        <a href="./event_schedule.php" class="badge sk-fade-bottom badge-lg badge-orange badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                            <span class="text-white fw-normal font-size-sm">06 Aprıl</span>
                        </a>
            ...
            <div class="col-md mb-6">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="./event_schedule.php" class="card-img d-block sk-thumbnail img-ratio-3 card-hover-overlay"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-3.jpg" alt="..."></a>
                        <a href="./event_schedule.php" class="text-underline text-white card-text-overlay position-absolute h5 mb-0 center">GET TICKET</a>
                        <a href="./event_schedule.php" class="badge sk-fade-bottom badge-lg badge-orange badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                            <span class="text-white fw-normal font-size-sm">06 Aprıl</span>
                        </a>
