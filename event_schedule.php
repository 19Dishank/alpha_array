                ...
                <div class="rounded bg-white p-5 p-lg-8">
                    ...
                    <div class="row w-xl-65 mx-xl-auto text-center">
                        <div class="col-6 col-md-3 mb-6 mb-md-0">
                            <div class="h1 text-blue mb-2"><span data-bs-toggle="countup" data-from="0" data-to="40" data-aos data-aos-id="countup:in"></span></div>
                            <p class="h5 mb-0">DAYS</p>
                        </div>

                        <div class="col-6 col-md-3 mb-6 mb-md-0">
                            <div class="h1 text-blue mb-2"><span data-bs-toggle="countup" data-from="0" data-to="59" data-aos data-aos-id="countup:in"></span></div>
                            <p class="h5 mb-0">HOURS</p>
                        </div>

                        <div class="col-6 col-md-3 mb-6 mb-md-0">
                            <div class="h1 text-blue mb-2"><span data-bs-toggle="countup" data-from="0" data-to="27" data-aos data-aos-id="countup:in"></span></div>
                            <p class="h5 mb-0">MINUTES</p>
                        </div>

                        <div class="col-6 col-md-3 mb-6 mb-md-0">
                            <div class="h1 text-blue mb-2"><span data-bs-toggle="countup" data-from="0" data-to="10" data-aos data-aos-id="countup:in"></span></div>
                    ...
                    <div class="col-md mb-5 mb-xl-0">
                        <div class="card">
                            ...
                            <div class="card-zoom position-relative d-flex justify-content-center">
                                ...
                                <a href="#" class="rounded-circle overflow-hidden card-hover-overlay position-relative d-block" style="max-width: 150px;"><img class="rounded-circle mx-auto shadow-light-lg img-fluid" src="assets/img/instructors/instructor-5.jpg" alt="..."></a>
                            </div>
                    ...
                    <div class="col-md mb-5 mb-xl-0">
                        <div class="card">
                            ...
                            <div class="card-zoom position-relative d-flex justify-content-center">
                                ...
                                <a href="#" class="rounded-circle overflow-hidden card-hover-overlay position-relative d-block" style="max-width: 150px;"><img class="rounded-circle mx-auto shadow-light-lg img-fluid" src="assets/img/instructors/instructor-6.jpg" alt="..."></a>
                            </div>

                            <!-- Footer -->
                            <div class="card-footer px-0 text-center pt-4 pb-0">
                                <a href="#" class="d-block"><h5 class="mb-0">Anna Richard</h5></a>
                    ...
                    <div class="col-md mb-5 mb-xl-0">
                        <div class="card">
                            ...
                            <div class="card-zoom position-relative d-flex justify-content-center">
                                ...
                                <a href="#" class="rounded-circle overflow-hidden card-hover-overlay position-relative d-block" style="max-width: 150px;"><img class="rounded-circle mx-auto shadow-light-lg img-fluid" src="assets/img/instructors/instructor-7.jpg" alt="..."></a>
                            </div>

                            <!-- Footer -->
                            <div class="card-footer px-0 text-center pt-4 pb-0">
                                <a href="#" class="d-block"><h5 class="mb-0">Kathelen Monero</h5></a>
                    ...
                    <div class="col-md mb-5 mb-xl-0">
                        <div class="card">
                            ...
                            <div class="card-zoom position-relative d-flex justify-content-center">
                                ...
                                <a href="#" class="rounded-circle overflow-hidden card-hover-overlay position-relative d-block" style="max-width: 150px;"><img class="rounded-circle mx-auto shadow-light-lg img-fluid" src="assets/img/instructors/instructor-8.jpg" alt="..."></a>
                            </div>

                            <!-- Footer -->
                            <div class="card-footer px-0 text-center pt-4 pb-0">
                                <a href="#" class="d-block"><h5 class="mb-0">Kristen Pala</h5></a>
