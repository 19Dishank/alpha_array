...
<body class="bg-white">
    ...
    <header class="py-8 py-md-11" style="background-image: none;">
        <div class="container text-center py-xl-2">
            <h1 class="display-4 fw-semi-bold mb-0">Pricing</h1>
    ...
    <div class="container mb-5">
        <!-- Form -->
        <h5 class="text-center mb-3">Save up to 10%</h5>
        <form class="d-flex align-items-center justify-content-center mb-6">
            <!-- Label -->
            <span>
                Annual
            </span>
            ...
            <!-- Switch -->
            <div class="custom-control custom-switch ms-4 me-1">
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4 mb-6 mb-lg-0">
                <!-- Card -->
                <div class="card rounded text-center card-border-action">
                    <div class="card-body position-relative p-6 pt-10 p-md-8 pt-md-10">
                        ...
                        <a href="#" class="btn btn-outline-dark btn-wide lift d-inline-block rounded">GET STARTED</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="card rounded text-center card-border-action">
                    <div class="card-body position-relative p-6 pt-10 p-md-8 pt-md-10">
                        ...
                        <h1 class="mb-5">$<span class="price" data-annual="599" data-monthly="59">599</span></h1>
            ...
            <div class="col-md-6 col-lg-4 mb-6 mb-lg-0">
                ...
                <div class="card rounded text-center card-border-action">
                    <div class="card-body position-relative p-6 pt-10 p-md-8 pt-md-10">
                        ...
                        <h1 class="mb-5">$<span class="price" data-annual="999" data-monthly="99">999</span></h1>
                        <p class="mb-8">Standard listing submission, active for 30 days.</p>
