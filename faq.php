...
<body class="bg-white">
        ...
        <div class="w-xl-65 mx-auto">
            <div class="mb-8" id="accordionCurriculum">
                ...
                <div class="border rounded shadow mb-6 overflow-hidden">
                    <div class="d-flex align-items-center" id="curriculumheadingOne<?php echo $result['faq_id']?>">
                        <h5 class="mb-0 w-100">
                            <button class="d-flex align-items-center text-left p-5 min-height-80 text-dark fw-medium collapse-accordion-toggle line-height-one" type="button" data-bs-toggle="collapse" data-bs-target="#CurriculumcollapseOne<?php echo $result['faq_id']?>" aria-expanded="false" aria-controls="CurriculumcollapseOne<?php echo $result['faq_id']?>">
                    ...
                    <div id="CurriculumcollapseOne<?php echo $result['faq_id']?>" class="collapse " aria-labelledby="curriculumheadingOne" data-parent="#accordionCurriculum">
    ...
    <section class="py-6 py-md-11 border-top border-bottom jarallax" data-jarallax data-speed=".8" style="background-image: url(assets/img/illustrations/illustration-1.jpg)">
        <div class="container text-center py-xl-4">
            ...
            <div class="mx-auto">
                <a href="./course_list.php" class="btn btn-primary btn-x-wide lift d-inline-block">GET STARTED NOW</a>
            </div>
        </div>
    </section>
