                                    ...
                                    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="product-subtotal">Buy Date</th>
                                                <th class="product-subtotal">Expire Date</th>
                                                <th class="product-subtotal">Status</th>
                                                <th class="product-subtotal">Exam Link</th>
                                                  ...
                                                  <a class="d-block"><?php echo date("d-m-Y", strtotime($result['date'])); ?></a>
                                                    ...
                                                    <td class="product-remove">
                                                       <?php 
                                                            ...
                                                            {
                                                                echo '<span class="bg-success" style="padding:10px;width:20px;border-radius:2px;">Active</span>';
                                                            } 
                                                            else
                                                            {
                                                    ...
                                                    <td class="product-subtotal" data-title="Total">
                                                        <?php 
                                                            if(isset($result['exam_link']))
                                                            {
                                                                ?>
                                                                <u><a href="<?php echo $result['exam_link'];?>" target="_blank" style="color: blue;">Exam Link Here</a></u>
                                                                <?php 
                                                       ...
                                                       <!-- <a href="<?php echo $result['exam_link'];?>">Exam Link Here</a> -->
                                                    </td>
