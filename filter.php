...
//echo "<br>";
//echo $brandii;
$sql = mysqli_query($cnn,"select * 
from categories_tbl,sub_categories_tbl,topic_tbl,course_tbl 
where course_tbl.topic_id=topic_tbl.topic_id and topic_tbl.sub_cat_id=sub_categories_tbl.sub_cat_id
 and sub_categories_tbl.categories_id=categories_tbl.categories_id 
 and  categories_tbl.categories_id IN ('$brandii')");
//echo "select * from course_tbl,topic_tbl,sub_categories_tbl 
//WHERE course_tbl.topic_id=topic_tbl.topic_id and 
//sub_categories_tbl.sub_cat_id=topic_tbl.sub_cat_id and 
//topic_tbl.sub_cat_id IN ('$brandii')";
// echo "select * from course_tbl,topic_tbl,sub_categories_tbl 
// 						WHERE course_tbl.topic_id=topic_tbl.topic_id and 
// 						sub_categories_tbl.sub_cat_id=topic_tbl.sub_cat_id and 
// 						topic_tbl.sub_cat_id IN ('$brandii')";
?>
                ...
                <div class="border rounded-lg px-6 pt-6 bg-white">
                        <?php
                        while($row_course=mysqli_fetch_array($sql)) {   
                        ?>
