        ...
        <div class="row row-cols-md-2 row-cols-lg-3 mb-8">
            <div class="col-md mb-6">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="./blog_detail.php" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-1.jpg" alt="..."></a>

                        <a href="./blog_detail.php" class="badge sk-fade-bottom badge-lg badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        <ul class="nav mx-n3 mb-3">
                            <li class="nav-item px-3">
                                <a href="./blog_detail.php" class="d-flex align-items-center text-gray-800">
                        ...
                        <!-- Heading -->
                        <a href="./blog_detail.php" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52">The Best Destinations to Begin Your Round the World Trip</h5></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md mb-6">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="./blog_detail.php" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-2.jpg" alt="..."></a>
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        ...
                        <!-- Heading -->
                        <a href="./blog_detail.php" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52">An Indigenous Anatolian Syllabic Script From 3500 Years Ago</h5></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md mb-6">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="./blog_detail.php" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-3.jpg" alt="..."></a>

                        <a href="./blog_detail.php" class="badge badge-lg sk-fade-bottom badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        ...
                        <!-- Heading -->
                        <a href="./blog_detail.php" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52">10 Best Countries to Visit for Beginner Travelers</h5></a>
                    </div>
                </div>
            </div>
