...
<body class="">
    ...
    <section class="pt-5 pb-9 py-md-11 bg-white mb-8 border-bottom" >
        <div class="container" >
            ...
            {
            ?>
                <h1>Search for "<?php echo $_POST['search_name']?>"</h1>
            <?php }
            ?>
            <div class="mx-n3 mx-md-n4" data-flickity='{"pageDots": false, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}' >
                ...
                if(isset($_POST['sbtn'])) 
                {
                    ...
                    $str="select * from course_tbl,topic_tbl where topic_tbl.topic_id=course_tbl.topic_id and topic_tbl.topic_name like '%".$_POST['search_name']."%' and  course_tbl.course_status='1'";
                    //echo $str;die;
                }
                else
                {
                    $str="select * from course_tbl,tutor_tbl where course_tbl.tutor_id=tutor_tbl.tutor_id and tutor_tbl.tutor_status='1' and  course_tbl.course_status='1' limit 25 offset 20";
                }
                $data_course=mysqli_query($cnn,$str);
                $row_course=mysqli_fetch_array($data_course);
                // echo count($row_course); die;
        ...
        <div class="row">
                        ...
                        <div id="coursefiltercollapse1" class="collapse show mt-n2 px-6 pb-6" aria-labelledby="coursefilter1" data-parent="#courseSidebar">
                            ...
                            <ul class="list-unstyled list-group list-checkbox">
                                <?php 
                                    ...
                                    <input  name="ids[]" type="radio" class="custom-control-input ids" id="categorycustomcheckone<?php echo $row_categories['categories_name']; ?>" value="<?php echo $row_categories['sub_cat_id']; ?>">
                        ...
                        <div id="coursefiltercollapse2" class="collapse show mt-n2 px-6 pb-6" aria-labelledby="coursefilter2" data-parent="#courseSidebar">
                            ...
                            <ul class="list-unstyled list-group list-checkbox list-checkbox-limit">
                               <?php 
                                ...
                                ?>
                              <li class="custom-control custom-radio">
                                <input  name="idss[]" type="radio" class="custom-control-input idss" id="categorycustomcheckone<?php echo $row_tutor['tutor_name']; ?>" value="<?php echo $row_tutor['tutor_id']; ?>">
            ...
            <div class="col-xl-8" >
                <div class="border rounded-lg px-6 pt-6 bg-white">
                    ...
                    <?php 
                        $str="select * from course_tbl  where course_status='1' ";
                        $data_course=mysqli_query($cnn,$str);
                        while($row_course=mysqli_fetch_array($data_course))
                        {
                    ?>
                    ...
                    <div class="result card sk-fade flex-md-row mb-6 align-items-center row gx-0" id="getdata" >
                        ...
                        <div class="col-md-4 card-zoom position-relative" >
                            ...
                            <?php if (file_exists('tutor/images/course/'.$row_course['course_image']))  { ?>    
                            <img class="rounded shadow-light-lg" src="
                                tutor/images/course/<?php echo $row_course['course_image'];?>" alt="no">
                                <?php } 
                                else { ?>
                                    <img src="images/Black.png"height="80px" width="80px"></td>
                                <?php } ?>
                            </a>
                ...
                <!-- <nav class="mt-8 mb-11" aria-label="Page navigationa">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item active"><a class="page-link" href="course_list.php">1</a></li>
