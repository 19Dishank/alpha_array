...
<head>
    ...
    <title>Course Details | <?php echo $title;?></title>
...
.inactive{
 background: rgb(252 33 73 / 80%)!important;
  ...
  <body class="vertical-layout vertical-menu-modern boxicon-layout no-card-shadow 2-columns  navbar-sticky footer-static  menu-expanded pace-done" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
    <!-- modals -->
        <?php 
           $qry="select * from tutor_tbl,tutor_prof_detail_tbl where tutor_prof_detail_tbl.tutor_id=tutor_tbl.tutor_id and tutor_tbl.tutor_id='".$_SESSION['id']."'";
                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                               <?php $qry="select * from course_tbl,topic_tbl,tutor_tbl where course_tbl.topic_id=topic_tbl.topic_id and course_tbl.tutor_id=tutor_tbl.tutor_id";
									$test=mysqli_query($conn,$qry);
