...
<?php 
  $user_id = $_POST['user_id'];                 
     ...
     //$sql = "Select * from user_tbl,tutor_tbl,user_booking_tbl,course_tbl where user_booking_tbl.tutor_id=tutor_tbl.tutor_id and user_booking_tbl.course_id=course_tbl.course_id and user_tbl.user_id=$user_id";

    // $sql = "Select * from user_tbl,user_booking_tbl,course_tbl,tutor_tbl where user_booking_tbl.tutor_id=tutor_tbl.tutor_id and user_booking_tbl.user_id=user_tbl.user_id and  user_booking_tbl.course_id=course_tbl.course_id and user_tbl.user_id=$user_id";
    $sql="select * from user_tbl where user_tbl.user_id=$user_id";
    ...
    $sql2="Select * from user_tbl,user_booking_tbl,course_tbl,tutor_tbl where user_booking_tbl.tutor_id=tutor_tbl.tutor_id and user_booking_tbl.user_id=user_tbl.user_id and  user_booking_tbl.course_id=course_tbl.course_id and user_tbl.user_id=$user_id
    ";
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="images/student/<?php echo $user_image;?>" alt="Admin" class="rounded-circle" width="150" >

                    <!-- <?php if (file_exists('images/'.$row['user_image']) && !empty($row['user_image']))  { ?>
                    <td><img src="images/<?php echo $row['user_image'];?>" class="rounded-circle" alt="Admin" width="150"></td>
                    <?php } else { ?>
                    <td><img src="images/guest-user.jpg?>" class="round" class="rounded-circle" alt="Admin" width="150"></td>
                    <?php } ?> -->
