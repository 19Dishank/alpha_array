        ...
        <div class="navbar-container content">
         ...
         <!--      <ul class="nav navbar-nav bookmark-icons">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="javascript:void(0);" data-toggle="dropdown">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                  <div class="user-nav d-sm-flex d-none"><span class="user-name"><?php echo $_SESSION['name']; ?></span><span class="user-status text-muted">Available</span></div>
                  <span><?php 
                    $qry="select * from admin_tbl where admin_tbl.admin_id='".$_SESSION['id']."'";
                        //echo $qry;
                        $test=mysqli_query($conn,$qry);
                        $result=mysqli_fetch_array($test);
                    ?>

                   <!--  <img class="round" src="images/car.png" alt="avatar" height="45" width="45"> -->
                    <?php if (file_exists('images/'.$result['admin_image']) && !empty($result['admin_image']))  { ?>
                      <td><img src="images/<?php echo $result['admin_image'];?>" class="round" height="45" width="45"></td>
                      <?php } else { ?>
                ...
                <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item" 
                  href="edit_profile.php?upid=<?php echo $_SESSION['id']; ?>"><i class="bx bx-user mr-50"></i> Edit Profile</a><a class="dropdown-item" href="change_password.php"><i class="bx bxs-key"></i>Change Password</a><!-- <a class="dropdown-item" href="app-email.html"><i class="bx bx-envelope mr-50"></i>  My Inbox</a><a class="dropdown-item" href="app-todo.html"><i class="bx bx-check-square mr-50"></i>Task</a><a class="dropdown-item" href="app-chat.html"><i class="bx bx-message mr-50"></i> Chats</a> -->
                  <div class="dropdown-divider mb-0"></div>
                  <a class="dropdown-item" href="logout.php"><i class="bx bx-power-off mr-50"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
