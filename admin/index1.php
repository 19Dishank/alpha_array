  ...
  <div class="authentication-wrapper authentication-basic container-p-y">
    <div class="authentication-inner py-4">
      ...
      <div class="card">
        ...
        <span class="app-brand-text demo h3 mb-0 fw-bold"><img src="./images/Purple.png" class="" alt="..." height="30px">
            </span>
            </a>
          </div>
          <!-- /Logo -->
          <h4 class="mb-2">Welcome to AlphaArray👋</h4>
          <p class="mb-4">Please sign-in to your account and start the adventure</p>

          <form id="custom_val"  class="mb-3" method="POST" autocomplete="off">
            <div class="mb-3">
              <label for="email" class="form-label">Email or Username</label>
              <input type="email" class="form-control" name="mail" placeholder="Enter your email or username" autofocus>
            </div>
             <div class="mb-3">
