...
<head>
    ...
    <title>Tutor Degree Details | <?php echo $title;  ?></title>
        ...
        <div class="card-body card-dashboard">
          ...
          <div class="table-responsive">
             <table class="table table-striped dataex-html5-selectors dataTable">
              ...
              </thead> <tbody> <?php $qry="select * from tutor_degree_tbl,tutor_tbl,degree_tbl where tutor_degree_tbl.tutor_id=tutor_tbl.tutor_id and tutor_degree_tbl.degree_id=degree_tbl.degree_id";
              ...
              <tr> 
                ...
                <!-- <td><?php echo $result['degree_image'];?></td> -->
                <?php if (file_exists('../tutor/images/degree/'.$result['degree_image']))  { ?>
                                    <td><img src="../tutor/images/degree/<?php echo $result['degree_image'];?>"height="100px" width="100px"></td>
                                    <?php } else { ?>
