            ...
            <div class="breadcrumbs-top">
              ...
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Inquiry Details
                  </li>
                </ol>
              </div>
            </div>
             ...
             <table class="table table-striped dataex-html5-selectors dataTable">
              <thead>
                <!-- <a href="category_add.php" class="add_cat"> 
					...
					<th>Course Name</th>
                    <th>Inquiry_description</th>
                    <th>Date</th>
                   
                    

                </tr>
              </thead> <tbody> <?php $qry="select * from inquiry_tbl,user_tbl,tutor_tbl,course_tbl where inquiry_tbl.tutor_id=tutor_tbl.tutor_id and inquiry_tbl.user_id=user_tbl.user_id and inquiry_tbl.course_id=course_tbl.course_id";
              ...
              <td width="10px"><button type="button" style="" id="user" class="btn" data-id="<?php echo $result['user_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg">
                ...
                <td><?php echo $result['inquiry_date'];?></td>
