...
<head>
    ...
    <title>Deactive Course Details | <?php echo $title;?></title>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Deactive Course Details</h4>
                      </div>
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                               <?php $qry="select * from course_tbl,topic_tbl,tutor_tbl where course_tbl.topic_id=topic_tbl.topic_id and course_tbl.tutor_id=tutor_tbl.tutor_id and course_status='0'";
									$test=mysqli_query($conn,$qry);
