<?php
  ...
  if(!isset($_SESSION['id']))
  {
     header('location:index.php');
		...
		{
           // echo "hello";die;
			if($_SESSION['password']==$_POST['cpass'])
			{
                //echo "hi";die;
				if($_POST['npass']==$_POST['cnpass'])
				{
                   // echo "if ";die;
					$str="update admin_tbl set admin_password='".$_POST['npass']."' where admin_email='".$_SESSION['mail']."'";
                  ...
                  <div class="card-body">
                    <form id="custom_val" method="POST" autocomplete="off">
                      ...
                      <div class="form-group">
                        <label class="form-label" for="basic-default-name">Enter Current Password:</label>
                        <input
                          type="password"
                          class="form-control"
                          id="cpass"
                      ...
                      <div class="form-group">
                        <label class="form-label" for="basic-default-name">Enter New Password:</label>
                        <input
                          type="password"
                          class="form-control"
                          id="npass"
                      ...
                      <div class="form-group">
                        <label class="form-label" for="basic-default-name">Confirm New Password:</label>
                        <input
                          type="password"
                          class="form-control"
                          id="cnpass"
