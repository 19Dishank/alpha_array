...
<head>
    ...
    <title>Tutor Social Details | <?php echo $title;  ?></title>
                         ...
                         <?php } ?>
						  <div class="table-responsive">
							 <table class="table table-striped dataex-html5-selectors dataTable">
							  ...
							  <?php $qry="select * from tutor_social_tbl,tutor_tbl where tutor_social_tbl.tutor_id=tutor_tbl.tutor_id";
