                  ...
                  <div class="col-12">
                    <div class="card">
                      ...
                      <?php } ?>
                                       ...
                                       <!--  <td><a onclick="return confirm('Are you sure want to delete?')" href="user_list.php?del=<?php echo $result['user_id']; ?> "><div class="fonticon-wrap">
                                        <i class="bx bx-trash-alt"></i> -->
                                          </div></a><!-- |<a href="vendor_details.php?upid=<?php echo $result['user_id'] ?>">
                                          <div class="fonticon-wrap">
