        ...
        <div class="card-body">
          ...
          <form id="formAuthentication" class="mb-3" method="POST" >
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="email" name="eid" placeholder="Enter your email" autofocus style="border-bottom: groove;border-top: none;border-left: none;border-right: none;">
            </div>
            <button type="submit" style="color: #5a8dee;background-color: #ffffff; border-color: #5a8dee;" name="sbtn" class="btn btn-primary glow position-relative w-100">Send Reset Link<i id="icon-arrow" class="bx bx-right-arrow-alt" ></i></button>
          </form>
