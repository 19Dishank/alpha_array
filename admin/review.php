...
<head>
    ...
    <title>Review | <?php echo $title;  ?></title>
        ...
        <div class="card-body card-dashboard">
          ...
          <div class="table-responsive">
             <table class="table table-striped dataex-html5-selectors dataTable">
              ...
              </thead> <tbody> <?php $qry="select * from review_tbl,user_tbl,tutor_tbl where review_tbl.user_id=user_tbl.user_id and review_tbl.tutor_id=tutor_tbl.tutor_id";
                ...
                <td><?php echo $result['created_date'];?></td>
                 ...
                 <td>
                                    ...
                                    <?php }?>
                                        ...
                                        <?php if($result['review_status']==0) {echo "<span class='text-danger'>Inactive</span>";} else { echo "<span class='text-success'>Active</span>";}  ?> --> 

                                        <label class="switch">
                      
                      <?php if($result['review_status']==1) { ?>
                        <input type="checkbox" style="" checked id="myCheck" onchange="change_sts('<?php echo $result['review_id']?>','<?php echo $result['review_status']?>');">
                        <span class="slider round"></span>
                      
                      <?php } else { ?>
                         <input type="checkbox" id="myCheck" style=" background-color: #2196F3 !important;" onchange="change_sts('<?php echo $result['review_id']?>','<?php echo $result['review_status']?>');">
