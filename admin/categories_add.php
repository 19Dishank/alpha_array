<?php
  ...
  $qry1="select * from categories_tbl";
  ...
  {
    $up_id=$_GET['upid'];
    $qry="select * from categories_tbl where categories_id=".$up_id;
   $test=mysqli_query($conn,$qry);
   while($res=mysqli_fetch_array($test))
   {
    $cname=$res['categories_name'];
   }
  ...
  if(isset($_POST['sbtn']))
  {
    ...
    if(isset($up_id))
    {
      $qry="update categories_tbl set categories_name='".$_POST['cname']."' where categories_id=".$up_id;
    ...
    {
      $cat_status=1;
      $qry="insert into categories_tbl values(Null,'".strtoupper($_POST['cname'] )."','".$cat_status."') ";
     ...
     // echo"Data inserted";
      $cat_success=mysqli_query($conn,$qry);
          ...
          {
            $_SESSION['danger']="Oops!! Alredey Category Existed...";
          }
    }
