...
<head>
    ...
    <title>Deactive Topic Details | <?php echo $title;  ?></title>
      ...
      <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Topic</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Topic List
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="card-body card-dashboard">
          ...
          <div class="table-responsive">
             <table class="table table-striped dataex-html5-selectors dataTable">
              ...
              </thead> <tbody> <?php $qry="select * from topic_tbl where topic_status='0'";
              ...
              <tr> 
                ...
                <td><?php echo $result['topic_name'];?></td>
                 ...
                 <td>
                      ...
                      <?php if($result['topic_status']==1) { ?>
                        <input type="checkbox" style="" checked id="myCheck" onchange="change_sts('<?php echo $result['topic_id']?>','<?php echo $result['topic_status']?>');">
                        <span class="slider round"></span>
                      
                      <?php } else { ?>
                         <input type="checkbox" id="myCheck" style=" background-color: #2196F3 !important;" onchange="change_sts('<?php echo $result['topic_id']?>','<?php echo $result['topic_status']?>');">
