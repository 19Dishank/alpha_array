...
<head>
    ...
    <title>Tutor Professor Detail List | <?php echo $title;?></title>
                    ...
                    <h5 class="content-header-title float-left pr-1 mb-0">Tutor</h5>
                      <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                          ...
                          <li class="breadcrumb-item active">Tutor Professional Detail List
                          </li>
                        </ol>
                      </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Tutor Professional Details List</h4>
                      </div>
                          ...
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <!-- <?php if($result['tutor_prof_status']==0) { ?>

                                     <a href="change_status.php?tutor_prof_detail_id=<?php echo $result['tutor_prof_detail_id'];?>&tutor_prof_status=<?php echo $result['tutor_prof_status'];?>"> 
                                  ...
                                  <?php }?>
                                      ...
                                      <?php if($result['tutor_prof_status']==0) {echo "<span class='text-danger'>Inactive</span>";} else { echo "<span class='text-success'>Active</span>";}  ?> -->   

                        <label class="switch">
                      
                      <?php if($result['tutor_prof_status']==1) { ?>
                        <input type="checkbox" style="" checked id="myCheck" onchange="change_sts('<?php echo $result['tutor_prof_detail_id']?>','<?php echo $result['tutor_prof_status']?>');">
                        <span class="slider round"></span>
                      
                      <?php } else { ?>
                         <input type="checkbox" id="myCheck" style=" background-color: #2196F3 !important;" onchange="change_sts('<?php echo $result['tutor_prof_detail_id']?>','<?php echo $result['tutor_prof_status']?>');">
       ...
       function change_sts(id,status)
             ...
             var id = id;
                      $.ajax({
                        ...
                        data: {
                          //  student_sts: 1,
                            tutor_prof_detail_id: id,
                            tutor_prof_status: status,
                          //  row_id: id,
                            //user_status: status,
                        },
