...
<body class="">
    ...
    <!-- PAGE TITLE
    ================================================== -->
    <header class="py-8 py-md-11 bg" style="background-image: none;">
        <div class="container text-center py-xl-2">
            <h1 class="display-4 fw-semi-bold mb-0">Courses List with Featured Course</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-scroll justify-content-center">
                    ...
                    <li class="breadcrumb-item text-gray-800 active" aria-current="page">
                        Courses List with Featured Course
                    </li>
                </ol>
            </nav>
        </div>
                ...
                <div class="mb-4 mb-xl-0 ms-xl-6">
                    ...
                    <form class="" method="POST">
                        <div class="input-group input-group-filter">
                            <input class="form-control form-control-sm placeholder-dark shadow-none border-end-0" type="search" name="search_name" placeholder="Search Topic" aria-label="Search">
    ...
    <section class="pt-5 pb-9 py-md-11 bg-white mb-8 border-bottom" >
        <div class="container" >
            ...
            <div class="mx-n3 mx-md-n4" data-flickity='{"pageDots": false, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}' >

                <?php 
                if(isset($_POST['sbtn'])) {

                    $str="select * from course_tbl,topic_tbl where topic_tbl.topic_id=course_tbl.topic_id and topic_tbl.topic_name like '%".$_POST['search_name']."%'";
                    // echo $str;die;
                }
                else
                {
                    $str="select * from course_tbl limit 25 offset 10";
                }
                $data_course=mysqli_query($cnn,$str);
                    ...
                    <div class="card border shadow p-2 lift sk-fade" >
                        ...
                        <div class="card-zoom position-relative" >
                            ...
                            <span class="sk-fade-right badge-float bottom-0 right-0 mb-2 me-2">
                                <ins class="h5 mb-0 text-white">₹<?php echo $row_course['course_fees'];?></ins>
                            </span>
                        </div>
    ...
    <div class="container mb-6 mb-xl-8 z-index-2">
        <div class="d-lg-flex align-items-center mb-6 mb-xl-0">
            <p class="mb-lg-0">We found <span class="text-dark">75 courses</span> available for you</p>
            <div class="ms-lg-auto d-lg-flex flex-wrap">
                <div class="mb-4 mb-lg-0 ms-lg-6">
                    <div class="border rounded d-flex align-items-center bg-white shadow choices-label h-50p">
                        <span class="ps-5">Sort by:</span>
        ...
        <div class="row">
                    ...
                    <div class="border rounded mb-6 bg-white">
                        ...
                        <div id="coursefiltercollapse1" class="collapse show mt-n2 px-6 pb-6" aria-labelledby="coursefilter1" data-parent="#courseSidebar">
                            ...
                            <ul class="list-unstyled list-group list-checkbox">
                                <?php 
                                    $str="select count(categories_tbl.categories_id) as count_cat_id,categories_name,categories_tbl.categories_id,sub_categories_tbl.sub_cat_id from categories_tbl,sub_categories_tbl,topic_tbl where topic_tbl.sub_cat_id=sub_categories_tbl.sub_cat_id and sub_categories_tbl.categories_id=categories_tbl.categories_id group by categories_tbl.categories_id";
                                    

                                      $data_categories=mysqli_query($cnn,$str);
                                     while($row_categories=mysqli_fetch_array($data_categories))
                                    {
                                    ?>
                                <li class="custom-control custom-checkbox">
                                <input  name="ids[]" type="checkbox" class="custom-control-input ids" id="categorycustomcheckone<?php echo $row_categories['categories_name']; ?>" value="<?php echo $row_categories['sub_cat_id']; ?>">
                                    <label class="custom-control-label font-size-base" for="categorycustomcheckone<?php echo $row_categories['categories_name']; ?>">
                                        <?php echo $row_categories['categories_name']; ?>(<?php echo $row_categories['count_cat_id']; ?>)
                                    </label>
                                </li>
                                <?php } ?>
                        ...
                        <div id="coursefiltercollapse2" class="collapse show mt-n2 px-6 pb-6" aria-labelledby="coursefilter2" data-parent="#courseSidebar">
                            ...
                            <ul class="list-unstyled list-group list-checkbox list-checkbox-limit">
                               <?php 
                                    ...
                                    $str="select count(course_tbl.course_id) as count_course_id,tutor_name,tutor_tbl.tutor_id,course_tbl.course_id from course_tbl,tutor_tbl WHERE course_tbl.tutor_id=tutor_tbl.tutor_id GROUP by tutor_tbl.tutor_id";

                                      $data_tutor=mysqli_query($cnn,$str);
                                     while($row_tutor=mysqli_fetch_array($data_tutor))
                                    {
                                ?>
                              <li class="custom-control custom-checkbox">
                                <input  name="idss[]" type="checkbox" class="custom-control-input idss" id="categorycustomcheckone<?php echo $row_tutor['tutor_name']; ?>" value="<?php echo $row_tutor['tutor_id']; ?>">
                                    <label class="custom-control-label font-size-base" for="categorycustomcheckone<?php echo $row_tutor['tutor_name']; ?>">
                                        <?php echo $row_tutor['tutor_name']; ?>(<?php echo $row_tutor['count_course_id']; ?>)
                                    </label>
                                </li>
                                <?php } ?>
                                <!-- <li class="custom-control custom-checkbox">
            ...
            <div class="col-xl-8" >
                <div class="border rounded-lg px-6 pt-6 bg-white">
                    ...
                    <?php 
                        $str="select * from course_tbl order by course_id desc limit 7 offset 7";
                        $data_course=mysqli_query($cnn,$str);
                        while($row_course=mysqli_fetch_array($data_course))
                        {
                    ?>
                    <!-- Card -->
                    <div class="result card sk-fade flex-md-row mb-6 align-items-center row gx-0" id="getdata" >
                        <!-- Image -->
                        <div class="col-md-4 card-zoom position-relative" >
                            <div class="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                                <a href="./course_detail.php?course_id=<?php echo $row_course['course_id'];?>" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                                ...
                                <a href="./course_detail.php?course_id=<?php echo $row_course['course_id'];?>" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                            ...
                            <a href="./course_detail.php?course_id=<?php echo $row_course['course_id'];?>" class="card-img sk-thumbnail img-ratio-2 d-block">
                                <img class="rounded shadow-light-lg" src="
                                tutor/images/course/<?php echo $row_course['course_image'];?>" alt="...">
                            </a>
                        ...
                        <div class="col-md-8 card-footer px-2 px-md-5 py-4 py-md-0 position-relative">
                            ...
                            <!-- Heading -->
                            <div class="position-relative">
                                <a href="./course_detail.php?course_id=<?php echo $row_course['course_id'];?>" class="d-block stretched-link"><h4 class="line-clamp-2 me-md-6 me-lg-10 me-xl-4 mb-3"><?php echo $row_course['course_details'];?></h4></a>
                                <ul class="nav mx-n3 mb-3">
                                    ...
                                    <li class="nav-item px-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="font-size-sm"><?php echo $row_course['available_duration'];?>&nbsp Month</div>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="row mx-n2 align-items-center">
                                    <div class="col px-2">
                                        <del class="font-size-sm">₹10000</del>
                                        <ins class="h4 mb-0 mb-lg-n1 ms-1">₹<?php echo $row_course['course_fees'];?></ins>
                                    </div>
                ...
                <nav class="mt-8 mb-11" aria-label="Page navigationa">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item "><a class="page-link" href="course_list.php">1</a></li>
                        <li class="page-item active"><a class="page-link" href="course_list2.php">2</a></li>
                        <li class="page-item"><a class="page-link" href="course_list3.php">3</a></li>
                        <li class="page-item">
...
<script>
        $(document).ready(function(){
        //alert('hello');
        $('.idss').on('change',function(){ //on checkboxes check
        //alert('hellodfdf');
        //sending checkbox value into serialize form

        var hi=$('.idss:checked').serialize();
        //alert(hi);
        if(hi){
