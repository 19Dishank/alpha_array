...
{
      $str="select * from tutor_tbl,course_tbl
       where course_tbl.course_id='".$_GET['course_id']."' ";
      //echo $str;
    ...
    <div class="container">
        <nav class="mb-5 mb-md-8 mt-2" aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-scroll">
                ...
                <li class="breadcrumb-item">
                    <a class="text-gray-800" href="course_list.php">
                        Courses List
                    </a>
                </li>
    ...
    <div class="container">
        <div class="row mb-8">
            ...
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                ...
                $str="select * from tutor_tbl,course_tbl where course_tbl.tutor_id=tutor_tbl.tutor_id and  course_tbl.course_id='".$_GET['course_id']."'";
                //echo $str;//die; 
                $test=mysqli_query($cnn,$str);
                $result=mysqli_fetch_array($test);
                $tutor_name=$result['tutor_name'];
                $_SESSION['tid']=$result['tutor_id'];
                ...
                <div class="d-md-flex align-items-center mb-5">
                    <div class="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6">
                        <div class="p-2">
                        <?php if (file_exists('tutor/images/'.$result['tutor_image']))  { ?>
                            <img src="tutor/images/<?php echo $result['tutor_image'];?>" alt="..." class="rounded-circle" width="68" height="68">
                            <?php } 
                                else { ?>
                                    <img src="images/avtar.png"height="80px" width="80px"></td>
                                <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        ...
                        <a href="#" class="font-size-sm text-gray-800"><?php echo $result['tutor_name']; ?></a>
                    </div>
                    <?php 
                        $sql="select * from course_tbl,topic_tbl,categories_tbl,sub_categories_tbl where sub_categories_tbl.categories_id=categories_tbl.categories_id and topic_tbl.sub_cat_id=sub_categories_tbl.sub_cat_id and course_tbl.topic_id=topic_tbl.topic_id and course_tbl.course_id='".$_GET['course_id']."'";
                        // echo $sql;die;
                        $test=mysqli_query($cnn,$sql);
                        $result=mysqli_fetch_array($test);
                     ?>

                    <div class="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        <h6 class="mb-0">Categories</h6>
                        <a href="#" class="font-size-sm text-gray-800"><?php echo $result['categories_name']; ?></a>
                    </div>
                    ...
                    <?php 
                      ...
                      $str="select SUM(rating) as Rating,COUNT(tutor_tbl.tutor_id) as tid from review_tbl,tutor_tbl where review_tbl.tutor_id=tutor_tbl.tutor_id and review_tbl.tutor_id='".$_SESSION['tid']."'";
                      //echo $str;die;
               ...
               <?php
                if(isset($_GET['course_id']))
                {
                      $str_video="select * from course_tbl,tutor_social_tbl where tutor_social_tbl.tutor_id=course_tbl.tutor_id and course_tbl.course_id='".$_GET['course_id']."'";
                      //echo $str_video;        

                ?>        
                <?php      
                      $row_video=mysqli_query($cnn,$str_video);
                      while($result_video=mysqli_fetch_array($row_video))
                      {  
                ?> 
                <a href="<?php echo $result_video['youtube'];?>" class="d-block sk-thumbnail rounded mb-6" data-fancybox>
                    ...
                    if(isset($_GET['course_id']))
                    {
                          $str_course="select * from course_tbl where course_tbl.course_id='".$_GET['course_id']."'";
                          //echo $str_course;
                    ...
                    <!-- <img class="rounded shadow-light-lg" src="assets/img/products/product-2.jpg" alt="..."> -->
                        ...
                        <img class="rounded shadow-light-lg" src="tutor/images/course/<?php echo $row_course['course_image'];?>" alt="...">
                    <?php }
                    } 
                    ?>
                </a>
            <?php }} ?>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="pills-overview-tab">
                        ...
                        <!-- <p class="mb-6 line-height-md"><?php echo $course_details; ?></p> -->
            ...
            <div class="col-lg-4">
                ...
                <div class="d-block rounded border p-2 shadow mb-6">
                    ...
                    <?php 
                        ...
                        $str_crse="select * from course_tbl where course_tbl.course_id='".$_GET['course_id']."'";
                        $row_crse12=mysqli_query($cnn,$str_crse);
                        $result_crse12=mysqli_fetch_array($row_crse12);
                        $duration=$result_crse12['available_duration'];
                        //echo $duration."<br>";
                        if(isset($_SESSION['uid'])!='')
                        {
                               $str_123="select * from user_booking_tbl where course_id='".$_GET['course_id']."' and user_id='".$_SESSION['uid']."'";
                               $data_course123=mysqli_query($cnn,$str_123);
                               $row_course123=mysqli_fetch_array($data_course123);
                               $no_buy_cour=mysqli_num_rows($data_course123);
                               //echo $no_buy_cour;
                               $buy_date=$row_course123['date'];
                        ...
                        $row_crse=mysqli_query($cnn,$str_crse);
                        while($result_crse=mysqli_fetch_array($row_crse))
                        {
                            $_SESSION['available_seat']=$result_crse['available_seat'];
                        ?>
                        <?php if(isset($days) && (strtotime($date2) < strtotime($date1))) { ?>
                        <div class="d-flex align-items-center text-alizarin mb-6">
                            ...
                            <span class="ms-2"> <?php echo $months." Month ".$days. " Days left"?></span>
                    ...
                    <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <ins class="h2 mb-0">₹<?php echo $result_crse['course_fees'] ?></ins>
                        ...
                        // if(isset($_SESSION['available_seat']) && $_SESSION['available_seat']<=0)
                        // {
                        //     echo "Seat Not available";
                            ...
                            { 
                                ...
                                {?>
                                    ...
                                    <button class="btn btn-danger btn-block mb-3" style="background: orangered;color: white;">Seat Not Available</button>
                                <?php } else { 
                                   if((time()-(60*60*24)) > strtotime($effectiveDate)) {
                                   ?>
                                
                                 <a href="javascript:void(0)" class="btn btn-primary btn-block mb-3 buy_now" data-amount="<?php echo $result_crse['course_fees'];?>" data-id="<?php echo $result_crse['course_id'];?>" >BUY NOW </a>
                                    <?php } else {?>
                            ...
                            <a href="login.php"><button class="btn btn-primary btn-block mb-3" type="button" name="button">BUY NOW</button></a>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex align-items-center py-3">
                                ...
                                <span><?php echo $result_crse['available_duration']; ?> Months</span>
                            </li>
                            <li class="list-group-item d-flex align-items-center py-3">
                                <div class="text-secondary d-flex icon-uxs">
                                    <!-- Icon -->
                                ...
                                <h6 class="mb-0 ms-3 me-auto">Available Seat</h6>
                                <span><?php echo $result_crse['available_seat']; ?></span>
                            </li>

                            <?php 
                              $str="select COUNT(booking_id) as Total_Student FROM user_booking_tbl,user_tbl where user_booking_tbl.user_id=user_tbl.user_id and user_booking_tbl.course_id='".$_GET['course_id']."'";
                              $count=mysqli_query($cnn,$str);
                            ...
                            <li class="list-group-item d-flex align-items-center py-3">
                                ...
                                <span><?php echo $result_count['Total_Student']; ?> students</span>
                            </li>
                            ...
                            <li class="list-group-item d-flex align-items-center py-4">
                                <a href="share1.php" class="mx-auto text-teal fw-medium d-flex align-items-center mt-2">
                                    <!-- Icon -->
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="border rounded px-6 px-lg-5 px-xl-6 pt-5 shadow">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="media mb-6 d-flex">
                                <a href="./course_detail.php" class="w-100p d-block me-5">
                                    <img src="././assets/img/photos/photo-1.jpg" alt="..." class="avatar-img rounded-lg h-90p w-100p">
                                </a>
                                <div class="media-body flex-grow-1">
                                    <a href="./course_detail.php" class="d-block">
        ...
        <div class="mx-n4 mb-12" data-flickity='{"pageDots": false, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
           <?php $qury=mysqli_query($cnn,"select * from course_tbl,topic_tbl where course_tbl.topic_id=topic_tbl.topic_id and course_tbl.course_id!='".$_GET['course_id']."' order by course_tbl.course_id desc"); 
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="./course_detail.php?course_id=<?php echo $row['course_id'];?>" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img class="rounded shadow-light-lg" src="tutor/images/course/<?php echo $row['course_image'];?>" alt="...">
                        </a>

                        <span class="sk-fade-right badge-float bottom-0 right-0 mb-2 me-2">
                            <ins class="h5 mb-0 text-white">₹<?php echo $row['course_fees']?></ins>
                        </span>
                    </div>
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        <!-- Preheading -->
                        <a href="./course_detail.php?course_id=<?php echo $row['course_id']?>"><span class="mb-1 d-inline-block text-gray-800"><?php echo $row['topic_name']?></span></a>

                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="./course_detail.php?course_id=<?php echo $row['course_id'];?>" class="d-block stretched-link"><h5 class="line-clamp-2 h-md-48 h-lg-58 me-md-8 me-lg-10 me-xl-4 mb-2"><?php echo $row['course_name']?></h5></a>
