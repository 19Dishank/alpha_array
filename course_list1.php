    ...
    <section class="pt-5 pb-9 py-md-11 bg-white mb-8 border-bottom" >
        <div class="container" >
            ...
            <div class="mx-n3 mx-md-n4" data-flickity='{"pageDots": false, "prevNextButtons": false, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}' >
                ...
                <?php 
                $str="select * from course_tbl order by course_id desc";
        ...
        <div class="row">
                        ...
                        <div id="coursefiltercollapse2" class="collapse show mt-n2 px-6 pb-6" aria-labelledby="coursefilter2" data-parent="#courseSidebar">
                            ...
                            <ul class="list-unstyled list-group list-checkbox list-checkbox-limit">
                                ...
                                <li class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label font-size-base" for="instructorscustomcheck1"><?php echo $row_tutor['tutor_name'];  ?></label>
                                </li>
                                <?php } ?>
                                <!-- <li class="custom-control custom-checkbox">
            ...
            <div class="col-xl-8" >
                <div class="border rounded-lg px-6 pt-6 bg-white">
                    ...
                    <?php 
                        $str="select * from course_tbl limit 7";
                        $data_course=mysqli_query($cnn,$str);
                        while($row_course=mysqli_fetch_array($data_course))
                        {
                    ?>
