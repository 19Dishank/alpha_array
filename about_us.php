    ...
    <section class="py-5 pt-md-11 pb-md-10 bg-light text-center">
        <div class="container">
            <div class="mb-md-8 mb-4">
                <h1>Why Study With AlphaArray</h1>
            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <p class="px-lg-7 px-xl-8">Learn anything from AlphaArray.</p>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <p class="px-lg-7 px-xl-8">AlphaArray is felxible for learning anything at low price.</p>
                </div>
                ...
                <div class="col-md-4 mb-4 mb-md-0">
                    ...
                    <p class="px-lg-7 px-xl-8">Learn from our highly qualified tutor.</p>
                </div>
            </div>
        </div>
    </section>
