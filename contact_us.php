    ...
    <div class="container">
        <div class="row row-cols-md-2 mb-8 mb-lg-11">
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <address class="">
                                    203 Bajrang Appt, Nilkanth Society, L.H.Road, Surat, <br>Gujarat, India.
                                </address>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <a href="tel:3159052321" class="text-gray-800 d-block">+919325741583</a>
                                <a href="tel:3159052322" class="text-gray-800 d-block">+918576324147</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl mb-6">
                        <div class="media d-flex">
                            ...
                            <div class="media-body flex-shrink-1">
                                ...
                                <a href="mailto:info@DreamEdu.com" class="text-gray-800">dreamedu17@gmail.com</a>
            ...
            <?php 
                if(isset($_POST['sbtn']))
                {
                    $contact_sql="insert into contact_us_tbl values(NULL,'".$_POST['name']."','".$_POST['email']."','".$_POST['msg']."')";
                    // echo $str;
                    $test=mysqli_query($cnn,$contact_sql);
            ...
            <div class="col-md">
                ...
                <form class="row" method="POST">
                    <div class="form-group mb-6 col-xl-6">
                        ...
                        <input type="text" class="form-control placeholder-1" id="exampleInputTitle1" name="name" placeholder="Enter Your Name">
                    </div>

                    <div class="form-group mb-6 col-xl-6">
                        <label for="exampleInputTitle2">Email</label>
                        <input type="email" class="form-control placeholder-1" id="exampleInputTitle2" name="email" placeholder="Enter Your Email">
                    </div>

                    <div class="form-group mb-6 col-12">
                        <label for="exampleFormControlTextarea1">Message</label>
                        <textarea class="form-control placeholder-1" id="exampleFormControlTextarea1" name="msg" rows="6" placeholder="Content"></textarea>
                    </div>

                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block mw-md-300p" name="sbtn">SEND</button>
                    </div>
                </form>
            </div>
        </div>
