    ...
    <div class="container py-8 pt-lg-11">
        <div class="row">
            <div class="col-xl-8 mx-auto">
                <h1 class="text-capitalize">Keep your face always toward the sunshine - and shadows will fall behind you.</h1>

                <p class="me-xl-12">Master Figma app to get a job in UI Design, User Interface, User Experience design, Web Design & UX design.</p>
                ...
                <div class="d-md-flex align-items-center">
                    ...
                    <div class="mb-4 mb-md-0">
                        <a href="#" class="d-block"><h6 class="mb-0">Alison Dawn</h6></a>
    ...
    <div class="container">
        <div class="row mb-8 mb-md-12">
            <div class="col-xl-8 mx-auto">
                ...
                <p class="mb-6 line-height-md">Aliquam hendrerit sollicitudin purus, quis rutrum mi accumsan nec. Quisque bibendum orci ac nibh facilisis, at malesuada orci congue. Nullam tempus sollicitudin cursus. Ut et adipiscing erat. Curabitur this is a text link libero tempus congue.</p>
        ...
        <div class="row row-cols-md-2 row-cols-lg-3 mb-8 mb-md-11">
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="./course-single-v1.html" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-1.jpg" alt="..."></a>

                        <a href="./course-single-v1.html" class="badge sk-fade-bottom badge-lg badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        ...
                        <!-- Heading -->
                        <a href="./course-single-v1.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52">The Best Destinations to Begin Your Round the World Trip</h5></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="./course-single-v1.html" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-2.jpg" alt="..."></a>
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        ...
                        <!-- Heading -->
                        <a href="./course-single-v1.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52">An Indigenous Anatolian Syllabic Script From 3500 Years Ago</h5></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md mb-5 mb-lg-0">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    <!-- Image -->
                    <div class="card-zoom position-relative">
                        <a href="./course-single-v1.html" class="card-img d-block sk-thumbnail img-ratio-3"><img class="rounded shadow-light-lg img-fluid" src="assets/img/post/post-3.jpg" alt="..."></a>

                        <a href="./course-single-v1.html" class="badge badge-lg sk-fade-bottom badge-purple badge-pill badge-float bottom-0 left-0 mb-4 ms-4 px-5 me-4">
                    ...
                    <div class="card-footer px-2 pb-0 pt-4">
                        ...
                        <!-- Heading -->
                        <a href="./course-single-v1.html" class="d-block"><h5 class="line-clamp-2 h-48 h-lg-52">10 Best Countries to Visit for Beginner Travelers</h5></a>
                    </div>
                </div>
            </div>
        </div>
