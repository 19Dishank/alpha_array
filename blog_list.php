            ...
            <div class="col-md-7 col-lg-8 col-xl-9 mb-5 mb-md-0">
                ...
                <div class="row mb-6 align-items-center">
                    ...
                    <div class="col-lg-6 col-xl-7">
                        ...
                        <p class="line-clamp-3 mb-6 mb-xl-8 me-xl-6">Convallis vitae, nunc ut venenatis, lectus. Tellus nunc orci dolor nec facilisis et lacus, eu aliquet. Amet imperdiet ac venenatis, lacus. Tortor interdum quisque et, eu etiam ac.</p>
                        ...
                        <div class="d-md-flex align-items-center">
                            ...
                            <div class="mb-4 mb-md-0">
                                <a href="./blog-single.html" class="d-block"><h6 class="mb-0">Alison Dawn</h6></a>
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="media mb-6 d-flex">
                                <a href="./blog-single.html" class="mw-70p d-block me-5">
                                    <img src="././assets/img/photos/photo-1.jpg" alt="..." class="avatar-img rounded-lg h-70p o-f-c">
                                </a>
                            ...
                            <li class="media mb-6 d-flex">
                                <a href="./blog-single.html" class="mw-70p d-block me-5">
                                    <img src="././assets/img/photos/photo-2.jpg" alt="..." class="avatar-img rounded-lg h-70p o-f-c">
                                </a>
                                <div class="media-body flex-shrink-1">
                                    <a href="./blog-single.html" class="d-block">
                            ...
                            <li class="media mb-0 d-flex">
                                <a href="./blog-single.html" class="mw-70p d-block me-5">
                                    <img src="././assets/img/photos/photo-14.jpg" alt="..." class="avatar-img rounded-lg h-70p o-f-c">
                                </a>
                                <div class="media-body flex-shrink-1">
                                    <a href="./blog-single.html" class="d-block">
