...
<head>
    ...
    <title>Contact List | <?php echo $title;?></title>
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $result['contact_address']?></td>
                                    <td><?php echo $result['contact_city']?></td>
                                    <td><?php echo $result['contact_pincode']?></td>
                                    <td><?php echo $result['contact_state_country']?></td>
