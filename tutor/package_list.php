...
<head>
    ...
    <title>Package List | <?php echo $title;?></title>
                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from package_tbl where package_tbl";
                                ...
                                <?php if($result['package_status']==0) { ?>
                                   ...
                                   <a href="change_status.php?package_id=<?php echo $result['package_id'];?>&package_status=<?php echo $result['package_status'];?>"> 
                                ...
                                <?php }?>
                                    ...
                                    <td><a href="?del_id=<?php echo $result['package_id']; ?>"><div class="fonticon-wrap">
                                              <i class="bx bx-trash" style="font-size:20px"></i>
                                          </div></a> | <a href="package_add.php?up_id=<?php echo $result['package_id']; ?>">
                                      <div class="fonticon-wrap">
