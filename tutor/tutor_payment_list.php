...
<head>
    ...
    <title>Tutor Payment List | <?php echo $title;?></title>
                    ...
                    <h5 class="content-header-title float-left pr-1 mb-0">Tutor</h5>
                      <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                          ...
                          <li class="breadcrumb-item active">Tutor Payment List
                          </li>
                        </ol>
                      </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Tutor Payment List</h4>
                      </div>
                      <div class="card-body card-dashboard">
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from tutor_payment_tbl,user_booking_tbl,user_tbl,tutor_tbl where tutor_payment_tbl.booking_id=user_booking_tbl.booking_id and user_booking_tbl.user_id=user_tbl.user_id and user_booking_tbl.tutor_id=tutor_tbl.tutor_id";
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $result['user_name']?>
                                      <button type="button" style="" id="user" class="btn" data-id="<?php echo $result['user_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg">
                                    ...
                                    <td>
                                    <?php if($result['tutor_payment_status']==0) { ?>

                                     <a href="change_status.php?tutor_payment_id=<?php echo $result['tutor_payment_id'];?>&tutor_payment_status=<?php echo $result['tutor_payment_status'];?>"> 
                                  ...
                                  <?php }?>
                                      ...
                                      <?php if($result['tutor_payment_status']==0) {echo "<span class='text-danger'>Inactive</span>";} else { echo "<span class='text-success'>Active</span>";}  ?>      
                                  </td>
                                  </tr>
                                <?php
                                 } 
