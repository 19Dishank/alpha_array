                    ...
                    <h5 class="content-header-title float-left pr-1 mb-0">Qualification</h5>
                      <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                          ...
                          <li class="breadcrumb-item active">Degree/Certificate List
                          </li>
                        </ol>
                      </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Degree/Certificate List</h4>
                      </div>
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                ...
                                $qry="select * from tutor_degree_tbl,tutor_tbl,degree_tbl where tutor_degree_tbl.degree_id=degree_tbl.degree_id and tutor_degree_tbl.tutor_id=tutor_tbl.tutor_id and tutor_tbl.tutor_id='".$_SESSION['tid']."'";
                                $test=mysqli_query($cnn,$qry);
                                while($result=mysqli_fetch_array($test))
                                {
                                ?>
                                <tr>
                                    <?php if (file_exists('images/'.$result['degree_image']))  { ?>
                                    <td><img src="images/<?php echo $result['degree_image'];?>"height="100px" width="100px"></td>
                                    <?php } else { ?>
                                    ...
                                    <td><a href="?del_id=<?php echo $result['tutor_degree_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')"><div class="fonticon-wrap">
                                          ...
                                          </div></a> | <a href="degree_add.php?up_id=<?php echo $result['tutor_degree_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')">
...
<!--/ Scroll - horizontal and vertical table -->
    ...
    if(isset($_GET['del_id']))
    {
      ...
      echo "<script>window.location='degree_certificate_list.php'</script>";
      header('location:degree_certificate_list.php');
    }
    ?>
