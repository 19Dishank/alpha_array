...
<?php
    if(isset($_POST['sbtn']))
    {  
    $qry="select * from tutor_tbl where tutor_email='".$_POST['eid']."'";
    //echo $qry;die;
     ...
     if(mysqli_num_rows($result)>0)
     {
        ...
        $_SESSION['user_name_data']=$data['tutor_name'];
        $otp=rand(100000,999999);
                    ...
                    <div class="c-email" style="width:60%;margin:auto;border:1px solid #BAE3FF;border-radius:5px;padding:30px 30px 12px 30px;">
                      ...
                      <div class="c-email__content">
                        ...
                        <div style="font-size:10px;font-family:roboto;color:#383838;text-align:center">
                            ...
                            <o>-</o><br>
                            <o>AlphaArray Infotech</o><br>
                            <o>99552 44556, 99556 22885</o><br>
                            <o>www.alphaarray2024@gmail.com</o><br>
                            <o>AlphaArray Infotech User Authentication</o>
                        </div>
                    </div>
                    </body>
                    </html>
    ...
    <div>
      ...
      <div class="card" style="">
        <div class="card-body">
          ...
          <!-- /Logo -->
          <h4 class="mb-2" style="text-align: center;font-weight: 700;color:white;">Forgot Password? 🔒</h4>
          <p class="mb-4" style="text-align: center;font-weight: 700;color:white;">Enter your email and we'll send you instructions to reset your password</p>
          <form id="formAuthentication" class="mb-3" method="POST">
            <div class="mb-3 form-holder">
              <span class="fa-solid fa-envelope" style="margin-left: 15px;"></span>
              <input type="email" class="form-control" id="email" name="eid" autofocus placeholder="Enter your email" >
            </div>
