...
<head>
    ...
    <title>Package Detail List | <?php echo $title;?></title>
                    ...
                    <h5 class="content-header-title float-left pr-1 mb-0">Package</h5>
                      <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                          ...
                          <li class="breadcrumb-item active">Package Detail List
                          </li>
                        </ol>
                      </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Package Details Table</h4>
                      </div>
                      <div class="card-body card-dashboard">
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from package_detail_tbl,package_tbl,tutor_tbl where package_detail_tbl.package_id=package_tbl.package_id and package_detail_tbl.tutor_id=tutor_tbl.tutor_id and tutor_tbl.tutor_id='".$_SESSION['tid']."'";
                                ...
                                <tr>
                                    ...
                                    <td><a href="?del_id=<?php echo $result['package_detail_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')"><div class="fonticon-wrap">
                                        <i class="bx bx-trash" style="font-size:20px"></i></a>
                                    </td>
                                  </tr>
                                <?php
                                 } 
...
<!--/ Scroll - horizontal and vertical table -->
    ...
    {
      $did=$_GET['del_id'];
      $str="delete from package_detail_tbl where package_detail_id=".$did;
      mysqli_query($cnn,$str);
      echo "<script>window.location='cat_list.php'</script>";
      header('location:package_detail_list.php.php');
    }
    ?>
