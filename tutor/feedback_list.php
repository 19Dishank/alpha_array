...
<head>
    ...
    <title>Feedback List | <?php echo $title;?></title>
                      ...
                      <div class="card-body card-dashboard">
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors dataTable">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from feedback_tbl,user_tbl where feedback_tbl.user_id=user_tbl.user_id";
                                ...
                                <tr>
                                    ...
                                    <!-- <td><?php echo $result['feedback_status']?></td> -->
                                    <td>
                                    <?php if($result['feedback_status']==0) { ?>
                                       
                                       <a href="change_status.php?feedback_id=<?php echo $result['feedback_id'];?>&feedback_status=<?php echo $result['feedback_status'];?>"> 
