...
<head>
    ...
    <title>User History List | <?php echo $title;?></title>
                    ...
                    <h5 class="content-header-title float-left pr-1 mb-0">User</h5>
                      <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                          ...
                          <li class="breadcrumb-item active">User History List
                          </li>
                        </ol>
                      </div>
                  </div>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">User History List</h4>
                      </div>
                      <div class="card-body card-dashboard">
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from user_history_tbl,user_booking_tbl where user_history_tbl.booking_id=user_booking_tbl.booking_id";
