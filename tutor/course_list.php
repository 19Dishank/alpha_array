                  ...
                  <div class="col-12">
                    <div class="card">
                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            <thead>
                               <a href="course_add.php" class="add_course"> 
                               <button value="Add Course" class="btn btn-outline-primary waves-effect" aria-hidden="true" style="margin: 60px 0px -86px;font-size: 13px;">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from course_tbl,topic_tbl,tutor_tbl where course_tbl.topic_id=topic_tbl.topic_id and course_tbl.tutor_id=tutor_tbl.tutor_id and tutor_tbl.tutor_id='".$_SESSION['tid']."'";
                                $test=mysqli_query($cnn,$qry);
                                ...
                                <tr>
                                    ...
                                    <!-- <td><button type="button" style="" id="user" class="btn" data-id="<?php echo $result['tutor_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg">
                                      <i class="fa fa-info-circle" style="font-size:21px"></i>
                                    </button><?php echo $result['tutor_name']?> 
                                    </td> -->
                                    ...
                                    <!-- <td><?php echo  substr($result['course_details'], 0,12)."<br> More.."; ?></td> -->

                                    <!-- <td><img src="images/<?php echo $result['course_image'];?>"height="100px" width="100px"></td> -->


                                    <!-- <td><?php echo $result['course_fees']?></td>
                                    <td><?php echo $result['available_seat']?></td>
                      ...
                      <?php } ?>
                                    ...
                                    <td><a href="?del_id=<?php echo $result['course_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')"><div class="fonticon-wrap">
                                              <i class="bx bx-trash" style="font-size:20px"></i>
                                          </div></a> | <a href="course_add.php?up_id=<?php echo $result['course_id']; ?>">
                                      <div class="fonticon-wrap">
