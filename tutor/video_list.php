                      ...
                      <?php } ?>
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            <thead>
                               <a href="video_add.php" class="add_course"> 
                               <button value="Add Course" class="btn btn-outline-primary waves-effect" aria-hidden="true" style="margin: 60px 0px -86px;font-size: 13px;">
                                <i class="bx bxs-plus-circle">     </i> Add Video
                                </button></a>
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from course_tbl,tutor_tbl,video where video.course_id=course_tbl.course_id and course_tbl.tutor_id=tutor_tbl.tutor_id and tutor_tbl.tutor_id='".$_SESSION['tid']."'";
                                $test=mysqli_query($cnn,$qry);
                                ...
                                <td><button type="button" style="" id="course" class="btn" data-id="<?php echo $result['course_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg">
                                  ...
                                  <td><?php echo $result['video_name']?></td>
                                    ...
                                    <?php if (file_exists('video/'.$result['location']))  { ?>
                                    <td>
                                         <video  controls auto play width=70%>
                                                <source src="video/<?php echo $result['location']?>">
                                          </video>
                                    </td>
                                    <?php } else { ?>
