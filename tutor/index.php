    ...
    if(isset($_POST['sub']))
    {
      ...
      if(mysqli_num_rows($result)>0)
      {
          ...
          if(isset($result_pack['package_exp_date']))
          {
              ...
              $date1=$result_pack['package_exp_date'];
          }
          ...
          $date2 = date('y-m-d');
          //if($days>0 && $count_pack>0 && (strtotime($date2) < strtotime($date1)))
          ...
          else
          {
           ...
           // exit;
            ...
            //echo "dsfsdfselsessss";
            //echo '<script>';
           // echo 'location.reload();';
            //echo 'window.location.href("test4.php")';
            //echo '</script>';
          }
      ...
      <div class="card" >
        <div class="card-body">
          ...
          <div class="app-brand justify-content-center">
            ...
            <span class="app-brand-text demo h3 mb-0 fw-bold"><img src="./images/w.png" class="" alt="..." height="50px">
            </span>
            </a>
          </div>
          <!-- /Logo -->
