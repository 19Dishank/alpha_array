...
if(!empty($_GET['up_id'])) 
 {
    ...
    $sn=$test['sub_cat_name'];
      ...
      if(isset($_POST['sbtn']))
      {
        if(!empty($_GET['up_id']))
        {
          $str="update sub_categories_tbl set sub_cat_name='".$_POST['sub_name']."' where sub_cat_id=".$upd_id;
        ...
        else
        {
          ...
          $sub_cat_success=mysqli_query($cnn,$str);
          if($sub_cat_success)
          {
                      ...
                      <form id="custom_val" method="POST">
                        <div class="form-group">
                          ...
                          <select class="form-control select2" name="categories_id"> 
                                  ...
                                  <?php $data=mysqli_query($cnn,"select * from categories_tbl");
