...
<?php 
  $user_id = $_POST['user_id'];                 
    ...
    // $sql = "Select * from user_tbl,tutor_tbl,user_booking_tbl,course_tbl where user_booking_tbl.tutor_id=tutor_tbl.tutor_id and user_booking_tbl.course_id=course_tbl.course_id ";
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                     ...
                     <?php 
                          ...
                          $gender_test=mysqli_query($cnn,$qry);
