...
<head>
  ...
  <!-- BEGIN: Body-->
  <body class="vertical-layout vertical-menu-modern boxicon-layout no-card-shadow 2-columns  navbar-sticky footer-static  menu-expanded pace-done dark-layout" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
