...
<?php
 ...
 {
    $upd_id=$_GET['up_id'];
    $qry=" select * from gallery_tbl where gallery_id=".$upd_id;
    ...
    $test=mysqli_fetch_array($result);
      ...
      if(isset($_POST['sbtn']))
      {
        if(!empty($_GET['up_id']))
        {
          ...
          $str="update gallery_tbl set images='".$image."' where gallery_id=".$upd_id;
        ...
        else
        {
          ...
          $image_status=1;
          $str="insert into gallery_tbl values(NUll,'".$image."','".$_SESSION['tid']."','".$image_status."')";
          //echo $str,die;
          $img_success=mysqli_query($cnn,$str);
          if($img_success)
          {
          ...
          {
             $_SESSION['duplicate']="Image is already exists....";  
          }
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title>Gallery Add | <?php echo $title;?></title>
                    ...
                    <h5 class="content-header-title float-left pr-1 mb-0">Gallery</h5>
                      <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="breadcrumb p-0 mb-0 pl-1">
                          ...
                          <li class="breadcrumb-item active">Add Photo
                          </li>
                        </ol>
                      </div>
                  </div>
                        ...
                        <form id="custom_val" method="POST" enctype="multipart/form-data">
                          <div class="form-group">
                            ...
                            <div class="custom-file">
                              <input type="file" accept="image/*" class="custom-file-input" id="customFile" name="profile"/>
   ...
   <script>
      ...
      messages: {
         profile: {
                       ...
                       //lettersonly: "Please Enter Category Name in Characters Only", 
