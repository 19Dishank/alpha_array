                          ...
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   ...
                                   <td>
                                <?php if($result['degree_status']==0) { ?>
                                   
                                   <a href="change_status.php?degree_id=<?php echo $result['degree_id'];?>&degree_status=<?php echo $result['degree_status'];?>"> 
                                ...
                                <?php }?>
                                    ...
                                    <?php if($result['degree_status']==0) {echo "<span class='text-danger'>Inactive</span>";} else { echo "<span class='text-success'>Active</span>";}  ?>      
                                </td>


                                    <td><a href="?del_id=<?php echo $result['degree_id']; ?>"><div class="fonticon-wrap">
                                              <i class="bx bx-trash" style="font-size:20px"></i>
                                          </div></a> | <a href="degree_add.php?up_id=<?php echo $result['degree_id']; ?>">
                                      <div class="fonticon-wrap">
