                      ...
                      <div class="card-body card-dashboard">
                         <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from review_tbl,user_tbl,tutor_tbl where review_tbl.user_id=user_tbl.user_id and review_tbl.tutor_id=tutor_tbl.tutor_id and tutor_tbl.tutor_id='".$_SESSION['tid']."'";
                                $test=mysqli_query($cnn,$qry);
                                ...
                                <tr>
                                    ...
                                    <td><a href="?del_id=<?php echo $result['review_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?')"><div class="fonticon-wrap">
...
<!--/ Scroll - horizontal and vertical table -->
    ...
    {
      $did=$_GET['del_id'];
      $str="delete from review_tbl where review_id=".$did;
