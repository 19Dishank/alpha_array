...
<head>
    ...
    <title>User List | <?php echo $title;?></title>
                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors">
                            ...
                            <tbody>
                                <?php 
                                $qry="select * from user_booking_tbl,user_tbl,course_tbl where user_booking_tbl.user_id=user_tbl.user_id and course_tbl.course_id=user_booking_tbl.course_id and user_booking_tbl.tutor_id='".$_SESSION['tid']."'";
                                ...
                                <tr>
                                    ...
                                    <!-- <?php if($result['user_status']==0) { ?>
                                       ...
                                       <a href="change_status.php?user_id=<?php echo $result['user_id'];?>&user_status=<?php echo $result['user_status'];?>"> 
