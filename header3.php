    ...
    <header class="navbar navbar-expand-xl navbar-light" >
        <div class="container">
            ...
            <a class="navbar-brand" href="./index.php">
                <img src="./assets/img/brand-gigas.svg" class="navbar-brand-img" alt="...">
            </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-md bg-primary rounded py-4 mt-4" aria-labelledby="navbarVerticalMenu">
                        ...
                        <li class="dropdown-item dropright">
                           ...
                           <?php 
                            $sub_sql="select * from sub_categories_tbl";
                            //echo $sql;die;
                            $sub_row=mysqli_query($cnn,$sub_sql);
                            while($sub_result=mysqli_fetch_array($sub_row))
                            {  
                            ?>
                            <div class="dropdown-menu ps-3 top-0 pe-0 py-0 shadow-none bg-transparent">
                                <div class="dropdown-menu-md bg-primary rounded dropdown-menu-inner">
                                    <a class="dropdown-item" href="./course-single-v1.html">
                                        <?php echo $sub_result['sub_cat_name']; ?>
                                    </a>
            ...
            <div class="collapse navbar-collapse z-index-lg" id="navbarCollapse">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle px-xl-4 text-gigas" id="navbarCourses" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                            Courses
                        </a>
                        <div class="dropdown-menu border-xl shadow-none dropdown-menu-lg" aria-labelledby="navbarCourses">
                            <div class="row gx-0">
                                <div class="col-md-4">
                                    ...
                                    <!-- List -->
                                    <a class="dropdown-item" href="./course_list.php">
                                        Course List
                                    </a>

                                    <!-- Details -->
                                    <a class="dropdown-item" href="./course_detail.php">
                                        Courses Details
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <!-- List -->
                                    <a class="dropdown-item" href="./instructors_list.php">
                                        Instructors List
                                    </a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle px-xl-4 text-gigas" id="navbarPages" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                            Pages
                        </a>
                                ...
                                <div class="col-6">
                                    <div class="row gx-0">
                                        <div class="col-12 col-lg-6">
                                            <!-- List -->
                                            <a class="dropdown-item" href="./event_list.php">
                                                Event List
                                            </a>
                                            <a class="dropdown-item" href="./event_schedule.php">
                                                Event Schedule
                                            </a>
                                            <a class="dropdown-item" href="./gallery.php">
                                                Gallery
                                            </a>
                                            <a class="dropdown-item mb-5 mb-lg-0" href="./pricing.php">
                                                Pricing
                                            </a>
                                        </div>
                                        <div class="col-12 col-lg-6">
                                            <!-- List -->
                                            <a class="dropdown-item" href="./about_us.php">
                                                About us
                                            </a>                                            
                                            <a class="dropdown-item" href="./contact_us.php">
                                                Contact us
                                            </a>
                                            <a class="dropdown-item mb-5 mb-lg-0" href="./terms_of_service.php">
                                                Terms of Service
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="row gx-0">
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <a class="dropdown-item mb-5 mb-lg-0" href="./become_instructor.php">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle px-xl-4 text-gigas" id="navbarBlog" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                            Blog
                        </a>
                        <ul class="dropdown-menu border-xl shadow-none" aria-labelledby="navbarBlog">
                            <li class="dropdown-item dropright">
                                <a class="dropdown-link" href="blog.php">
                                    Blog                                    
                                </a>
                            </li>
                            <li class="dropdown-item dropright">
                                <a class="dropdown-link" href="blog_list.php">
                                    Blog List
                                </a>
                            </li>
                            <li class="dropdown-item dropright">
                                <a class="dropdown-link" href="blog_detail.php">
                                    Blog Details
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle px-xl-4 text-gigas" id="navbarShop" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                            Shop
                        </a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle px-xl-4 text-gigas" id="navbarDocumentation" data-bs-toggle="dropdown" href="#" aria-haspopup="true" aria-expanded="false">
                            Documentation
                        </a>
            ...
            <ul class="navbar-nav flex-row ms-n4 ms-sm-auto ms-xl-0 me-n2 me-md-n4">
                <li class="nav-item border-0 px-1 px-md-3">
                    ...
                    <a href="login.php" class="nav-link d-flex p-3 bg-white-all rounded-circle position-relative text-gigas icon-xs" data-bs-toggle="modal" data-bs-target="#cartModal">
                        <span class="badge badge-gigas text-white rounded-circle fw-bold badge-float mt-n4 ms-n4 px-0 w-16 right-0" style="font-size: 8px;">2</span>
                        <!-- Icon -->
    ...
    <header class="navbar navbar-expand-xl navbar-light" >
        <div class="container">
            ...
            <ul class="navbar-nav flex-row ms-n4 ms-sm-auto ms-xl-0 me-n2 me-md-n4">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link d-flex p-3 bg-white-all rounded-circle text-gigas icon-xs" style="margin: -14px 2px -79px 2px";>
                    ...
                    <!-- <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="avatar avatar-lg">
                          ...
                          <?php if (file_exists('../edu/admin/images/'.$result['user_image']) && !empty($result['user_image']))  { ?>
                      <td><img src="../edu/admin/images/<?php echo $result['user_image'];?>" class="avatar-img rounded-circle" height="45" width="45"></td>
                      <?php } else { ?>
                      <td><img src="images/guest-user.jpg?>" class="avatar-img rounded-circle" height="45" width="45"></td>
                    <?php } ?>
                       ...
                       <!--  <td><img src="../edu/admin/images/<?php echo $user_image;?>" alt="..." class="round" height="45" width="45"></td> -->

                    </a>
                    <div class="dropdown-menu border-xl shadow-none dropdown-menu-md" aria-labelledby="navbarDocumentation">
                            <div class="list-group list-group-flush">
                                <a class="list-group-item" href="login.php">
